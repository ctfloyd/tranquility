...
public class Realm {
    ...
    private Map<String, JsObject> intrinsics = new HashMap<>();
...
//     private List<Map<AstNode, List<JsObject>>> templateMap;
    ...
    public static Realm createRealm(AstInterpreter interpreter) {
        // 1. Let realmRec be a new Realm Record.
        Realm realm = new Realm(interpreter);
    ...
    public Map<String, JsObject> getIntrinsics() {
        return intrinsics;
    }

    public void setIntrinsics(Map<String, JsObject> intrinsics) {
        this.intrinsics = intrinsics;
    }

    public void addIntrinsic(Intrinsic intrinsic) {
        intrinsics.put(intrinsic.getGlobalName(), intrinsic.getGlobalValue());
    }
    ...
    public void setRealmGlobalObject(JsObject globalObject, JsObject thisValue) {
        ...
        if (globalObject == null) {
            ...
            globalObject = JsObject.ordinaryObjectCreate(intrinsics.get(Intrinsic.OBJECT.getGlobalName()).getPrototypeOf().asObject());
        }
        ...
        GlobalEnvironment newGlobalEnv = new GlobalEnvironment(interpreter, globalObject, thisValue);
    ...
    public JsObject setDefaultGlobalBindings() {
        ...
        // b. Let desc tbe the fully populated data Property Descriptor for the property, containing the specified
