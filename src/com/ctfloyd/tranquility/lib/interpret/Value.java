...
public class Value {
    ...
    public Value sameValue(Value y) {
    ...
    public Value sameValueNonNumber(Value y) {
        ...
        if (asObject().isStringObject()) {
            ...
            return Value._boolean(((StringObject) asObject()).getString().equals(((StringObject) y.asObject()).getString()));
        }
        // TODO: 6. If x is a Boolean, then a. If x and y are both true or both false, return true; otherwise, return false.
        // TODO: 7
        // 8. If x and y are the same Object value, return true. Otherwise, return false;
        return Value._boolean(asObject() == y.asObject());
    }
